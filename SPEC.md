...
| 19 | Publication | README, bloc `contact`, version 1.0.0, projet Modrinth `zelda-master-sword` en brouillon avec sa version 1.0.0, icône du mod (§7.1) | **en cours** 17/09/2026 : manque la soumission à la modération |
