...
| Version | `0.1.0` au départ, **`1.0.0`** à la publication (17/09/2026) | ✅ |
...
| 19 | Publication | README, bloc `contact`, version 1.0.0, projet Modrinth `zelda-master-sword` en brouillon avec sa version 1.0.0 (§7.1) | **en cours** 17/09/2026 : manquent l'icône du mod et la soumission à la modération |
